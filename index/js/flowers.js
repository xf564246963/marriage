var FLOWERS = {
    ...
    setParameters: function (canvas, ctx) {
...
CHERRY_BLOSSOM.prototype = {
    ...
    init : function(isRandom){
        ...
        this.thresholdY = this.renderer.height / 4 * 3 + this.renderer.height * this.SURFACE_RATE * axis.rate;
    ...
    getAxis : function(){
        var rate = this.FOCUS_POSITION / (this.z + this.FOCUS_POSITION),
            ...
            y = this.renderer.height / 4 * 3 - this.y * rate;
